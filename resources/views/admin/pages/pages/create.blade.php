      ...
      <div class="block-content">
        ...
        <div class="row justify-content-center">
          <div class="col-md-11 col-lg-8">
            <form class="row" action="{{ route('admin.pages.store') }}" method="POST">
              @csrf
              <x-form.input name="name" label="Name" />
              <x-form.input name="title" label="Title" />
              <x-form.input iclass="ps-3" prefix="/" name="path" label="URL Path">
              ...
              <textarea name="content" id="pageContentField" hidden>{!! old('content') !!}</textarea>
                ...
                <div>
                  ...
                  <div class="form-check form-switch">
                    ...
                    <input class="form-check-input" type="checkbox" value="{{ App\Models\Page::STATUS_PUBLISHED }}"
                      id="published" name="status" @checked(old('status'))>
                  </div>
                </div>
